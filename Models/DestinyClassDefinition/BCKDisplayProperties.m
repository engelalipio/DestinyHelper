...
NSString *const kBCKDisplayPropertiesHasIcon = @"hasIcon";
...
- (instancetype)initWithDictionary:(NSDictionary *)dict
{
    ...
    if(self && [dict isKindOfClass:[NSDictionary class]]) {
            ...
            self.hasIcon = [[self objectOrNilForKey:kBCKDisplayPropertiesHasIcon fromDictionary:dict] boolValue];
...
- (NSDictionary *)dictionaryRepresentation
{
    ...
    [mutableDict setValue:[NSNumber numberWithBool:self.hasIcon] forKey:kBCKDisplayPropertiesHasIcon];
...
- (id)initWithCoder:(NSCoder *)aDecoder
{
    ...
    self.hasIcon = [aDecoder decodeBoolForKey:kBCKDisplayPropertiesHasIcon];
    return self;
}
...
- (void)encodeWithCoder:(NSCoder *)aCoder
{
    ...
    [aCoder encodeBool:_hasIcon forKey:kBCKDisplayPropertiesHasIcon];
}
